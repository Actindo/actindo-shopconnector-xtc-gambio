...
defined( '_VALID_XTC' ) or die( 'Direct Access to this location is not allowed.' );
  class upload {
    ...
    function save() {
      ...
      if( (!defined('SUPPRESS_UPLOAD_CHECKS') && move_uploaded_file($this->file['tmp_name'], $this->destination . $this->filename)) || (defined('SUPPRESS_UPLOAD_CHECKS') && rename($this->file['tmp_name'], $this->destination . $this->filename)) ) {
